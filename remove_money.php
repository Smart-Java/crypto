...
include_once ('./includes/connection_includes.php');
    ...
    if ($investorSession == true) {
        ...
        if (isset($_POST['removeMoneyBtnId'])) {
            $amount = filter_var(trim(mysqli_real_escape_string($connectionResult, $_POST['removeMoneyId'])), FILTER_SANITIZE_STRING);
            $removeMoney = new RemoveAddMoneyClass($amount);

            $result = $removeMoney ->removeAmount($connectionResult);
            $information = $result;
        }
?>
<!DOCTYPE html>
...
<body>
    <nav id="navbar" class="navbar navbar-light fixed-top justify-content-between" style="background-color:  #000; margin-bottom: 60px;">
        <a class="navbar-brand" href="#" style="color: #fff;">Remove Money</a>
        ...
        <div class="container-fluid">
            <div class="row" style="width: 100%; height: 1000px;">
                ...
                <div class="col-xl-12 col-sm-12 col-md-12" style="margin-top: 70px;">
                    <div class="row">
                        <p class="text-left ml-4" style="text-transform: Uppercase; font-weight: bold;">Remove Money</p>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-sm-12 col-md-12" style="background-color: #808090; border-radius: 10px; height: 50%; margin-left: 15px;">
                            <form class="row d-inline" method="post" action="remove_money.php?admin=<?php echo$investorId;?>&investor=<?php echo $_GET['investor'];?>">
                                ...
                                <div class="row" style="margin-bottom: 10px; padding-left: 10px; padding-top: 10px; padding-right: 10px;">
                                    <p class="col"><label for="removeMoneyId" style="margin-right: 50px;">Remove money: </label></p>
                                    <input type="number" name="removeMoneyId" id="removeMoneyId" style="width: 400px;" class="col">
                                </div>
                                <div class="text-right">
                                    <input type="submit" value="Go" class="btn" name="removeMoneyBtnId">
                                </div>
                            </form>
                        </div>
                    </div>
