			...
			<div>
				<div class="text-center">
					...
					<a class="logo" href="index.php">
						<img id="logo" class="img-responsive" src="images/backgrounds/favicon.png" alt="logo">
					</a>
					<!-- Logo Ends -->
					<!-- Coming Soon Content Starts -->
                    <!-- <video src="" width="100%">
                        <h3 class="coming-soon-title">Calling for maintance!</h3>
                        <p>You are advised to call the admin for site maintance in next 24hrs.</p>
                    </video>
					...
					<a class="custom-button refresh" id="refresh" href="#">refresh the page</a>
					<!-- Error 503 Content Starts -->
				</div>
			</div>
		</div>
