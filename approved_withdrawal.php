        ...
        <div class="container-fluid">
            <div class="row" style="width: 100%; height: 1000px;">
                ...
                <div class="col-md-12 col-sm-12 col-xl-12" style="margin-top: 70px;">
                    <div class="row">
                        <p style="text-transform: uppercase; margin-left: 30px; margin-bottom: 20px; font-weight: 700; color:#000000;">Here below are the approved withdrawals done by you:</p>
                    </div>
                    <div class="row">
                        <table class="table" style="margin-left: 30px; margin-right: 30px; border-radius: 20px;">
                            ...
                            <?php
                                ...
                                $selectWithdrawal = "SELECT `withdraw_id`, `withdraw_investor_code`, `means_of_withdraw`, `withdraw_code`, `withdraw_amount`, `withdraw_date`, `withdraw_comment` FROM `withdraw_deposit` WHERE `withdraw_approved` = '1' ORDER BY `withdraw_id` DESC";
                                    ...
                                    if ($numRows == 0) {
                                        ?>
                                            ...
                                            <div class="col-12 text-center">
                                                <p style="font-weight: 700; text-transform: uppercase;">Note: No approved Withdrawal done by you admin.</p>
                                            </div>
                                        <?php
                                    } else{
